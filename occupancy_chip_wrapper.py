...
command = f"python /app/occupancy_wrapper.py -p {args.platform} -s {args.slide} -l {args.lane} -c {args.cycle_start} -r {args.cycle_range} -o {output_path} -t {temp_path} -d {lane_path}"
